...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'أفلام آسيوية','asia.png', oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showRamdan', 'رمضان', 'rmdn.png', oOutputParameterHandler)
    ...
    oGui.addText(SITE_IDENTIFIER,'[COLOR olive]-----●★| Plays |★●-----[/COLOR]')
