...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    printDBG, printExc, GetE2VideoAspectChoices,
    GetE2VideoPolicyChoices, GetE2VideoPolicy,
    GetE2AudioCodecMixChoices
)
...
###################################################
import skin
from enigma import eLabel, getDesktop  # gRGB
...
# this foced for config : show init.py
if not hasattr(config.plugins, 'iptvplayer'):
    from Plugins.Extensions.IPTVPlayer import _
