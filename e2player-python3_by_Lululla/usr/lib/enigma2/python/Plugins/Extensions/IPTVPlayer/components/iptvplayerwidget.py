...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    ...
    printDBG, printExc, iptv_system,
    GetHostsList, IsHostEnabled,
    ...
    if screenwidth and screenwidth == 1920:
        skin = """
                    <screen position="center,center" size="1590,825" title="E2iPlayer %s">
                            ...
                            <eLabel position="0,e-40" size="1590,48" backgroundColor="#000d0f16" zPosition="-1" />
                            <eLabel position="0,90" size="1590,2" backgroundColor="grey" zPosition="2" />
                            ...
                            <widget name="headertext" position="5,0" zPosition="2" size="1080,60" font="Regular;30" transparent="1" backgroundColor="#00000000" />
                            <widget name="statustext" position="23,147" zPosition="1" size="985,120" font="Regular;30" halign="center" valign="center" transparent="1" backgroundColor="#00000000" />
                            <widget name="list" position="4,92" zPosition="2" size="1090,625" enableWrapAround="1" scrollbarMode="showOnDemand" transparent="1" backgroundColor="#00000000" />
                            <widget name="console" position="1090,384" zPosition="1" size="500,567" font="Regular;26" transparent="1" backgroundColor="#00000000" />
                            <widget name="cover" zPosition="2" position="1090,98" size="244,280" alphatest="blend" />
                            <widget name="playerlogo" zPosition="4" position="1090,5" size="240,80" alphatest="blend" />
                            <widget name="sequencer" position="3,93" zPosition="6" size="1090,625" font="Regular;160" halign="center" valign="center" transparent="1" backgroundColor="#00000000" />
        ...
        skin = """
                    <screen position="320,180" size="1280,720" title="E2iPlayer %s">

                            <eLabel position="0,0" size="1280,50" backgroundColor="#000d0f16" zPosition="-1" />
                            <eLabel position="0,e-40" size="1280,48" backgroundColor="#000d0f16" zPosition="-1" />
                            <eLabel position="0,55" size="1280,2" backgroundColor="grey" zPosition="2" />
                            <eLabel position="0,680" size="1280,2" backgroundColor="grey" zPosition="2" />

                            <!--#####red####/-->
                            <ePixmap pixmap="buttons/redbutton.png" position="32,e-40" size="250,6" alphatest="blend" objectTypes="key_red,Button,Label" transparent="1" />
                            <widget source="key_red" render="Pixmap" pixmap="buttons/redbutton.png" position="32,e-40" size="250,6" alphatest="blend" objectTypes="key_red,StaticText" transparent="1">
                              <convert type="ConditionalShowHide" />
                            </widget>
                            <widget name="key_red" position="27,e-40" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_red,Button,Label" transparent="1" />
                            <widget source="key_red" render="Label" position="27,e-40" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_red,StaticText" transparent="1" />
                            <!--#####green####/-->
                            <ePixmap pixmap="buttons/greenbutton.png" position="292,680" size="250,6" alphatest="blend" objectTypes="key_green,Button,Label" transparent="1" />
                            <widget source="key_green" render="Pixmap" pixmap="buttons/greenbutton.png" position="297,680" size="250,6" alphatest="blend" objectTypes="key_green,StaticText" transparent="1">
                              <convert type="ConditionalShowHide" />
                            </widget>
                            <widget name="key_green" position="292,680" size="250,45" zPosition="11" font="Regular; 30" valign="center" halign="center" backgroundColor="background" objectTypes="key_green,Button,Label" transparent="1" />
                            <widget source="key_green" render="Label" position="292,680" size="250,45" zPosition="11" font="Regular; 30" valign="center" halign="center" backgroundColor="background" objectTypes="key_green,StaticText" transparent="1" />
                            <!--#####yellow####/-->
                            <ePixmap pixmap="buttons/yellowbutton.png" position="552,680" size="250,6" alphatest="blend" objectTypes="key_yellow,Button,Label" transparent="1" />
                            <widget source="key_yellow" render="Pixmap" pixmap="buttons/yellowbutton.png" position="552,680" size="250,6" alphatest="blend" objectTypes="key_yellow,StaticText" transparent="1">
                              <convert type="ConditionalShowHide" />
                            </widget>
                            <widget name="key_yellow" position="552,680" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_yellow,Button,Label" transparent="1" />
                            <widget source="key_yellow" render="Label" position="552,680" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_yellow,StaticText" transparent="1" />
                            <!--#####blue####/-->
                            <ePixmap pixmap="buttons/bluebutton.png" position="822,680" size="250,6" alphatest="blend" objectTypes="key_blue,Button,Label" transparent="1" />
                            <widget source="key_blue" render="Pixmap" pixmap="buttons/bluebutton.png" position="822,680" size="250,6" alphatest="blend" objectTypes="key_blue,StaticText" transparent="1">
                              <convert type="ConditionalShowHide" />
                            </widget>
                            <widget name="key_blue" position="822,680" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_blue,Button,Label" transparent="1" />
                            <widget source="key_blue" render="Label" position="822,680" size="250,45" zPosition="11" font="Regular; 30" noWrap="1" valign="center" halign="center" backgroundColor="background" objectTypes="key_blue,StaticText" transparent="1" />
                            ...
                            <widget name="headertext" position="5,0" zPosition="1" size="1280,50" font="Regular;20" transparent="1" backgroundColor="#00000000" />
                            <widget name="statustext" position="5,140" zPosition="1" size="900,120" font="Regular;20" halign="center" valign="center" transparent="1" backgroundColor="#00000000" />
                            <widget name="list" position="10,65" zPosition="2" size="950,550" enableWrapAround="1" scrollbarMode="showOnDemand" transparent="1" backgroundColor="#00000000" />
                            <widget name="console" position="985,290" zPosition="1" size="279,390" font="Regular;20" transparent="1" backgroundColor="#00000000" />
                            <widget name="cover" zPosition="2" position="1029,63" size="180,220" alphatest="blend" />
                            <widget name="playerlogo" zPosition="4" position="1049,3" size="120,40" alphatest="blend" />
                            <widget name="sequencer" position="10,65" zPosition="6" size="950,510" font="Regular;160" halign="center" valign="center" transparent="1" backgroundColor="#00000000" />
                            <widget name="spinner" zPosition="2" position="463,200" size="16,16" transparent="1" alphatest="blend" />
                            <widget name="spinner_1" zPosition="1" position="463,200" size="16,16" transparent="1" alphatest="blend" />
                            <widget name="spinner_2" zPosition="1" position="479,200" size="16,16" transparent="1" alphatest="blend" />
                            <widget name="spinner_3" zPosition="1" position="495,200" size="16,16" transparent="1" alphatest="blend" />
