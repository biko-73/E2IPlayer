...
# from Plugins.Extensions.IPTVPlayer.components.cover import Cover, SimpleAnimatedCover
...
from Plugins.Extensions.IPTVPlayer.components.cover import Cover3, Cover
###################################################
...
class IPTVArticleRichVisualizer(Screen):
    ...
    def __prepareSkin(self):
        skin = """
                    <screen name="IPTVArticleRichVisualizerWidget" position="center,center" size="1590,825" title="Info...">
                        ...
                        <widget source="Event" render="Label" position="1039,363" size="494,40" font="Regular; 26" transparent="1" halign="center" valign="center" zPosition="99" backgroundColor="background">
    ...
    def __init__(self, session, artItem, addParams):
        ...
        self["actions"] = ActionMap(
            ['IPTVAlternateVideoPlayer', 'MoviePlayerActions', 'MediaPlayerActions', 'WizardActions', 'DirectionActions'],
            {
                "ok": self.key_ok,
                "back": self.key_back,
                "left": self.key_left,
