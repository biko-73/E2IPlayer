...
from Components.config import ConfigSelection, ConfigDirectory, ConfigYesNo, ConfigOnOff, ConfigInteger, \
...
# Verifica e inizializza la sottosezione
if not hasattr(config.plugins, 'iptvplayer'):
    from Plugins.Extensions.IPTVPlayer import _  # Import forzato

# Poi modifica la riga 43:
if hasattr(config.plugins, 'iptvplayer'):
