...
def load():
    ...
    oGui.addText(SITE_IDENTIFIER,'[COLOR olive]-----●★| Movies |★●-----[/COLOR]')

    oOutputParameterHandler.addParameter('siteUrl', MOVIE_NETFLIX[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'أفلام نيتفلكس', 'film.png', oOutputParameterHandler)
    ...
    oGui.addText(SITE_IDENTIFIER,'[COLOR olive]-----●★| Series |★●-----[/COLOR]')

    oOutputParameterHandler.addParameter('siteUrl', SERIE_NETFLIX[0])
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'مسلسلات نيتفلكس', 'mslsl.png', oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'مسلسلات إنمي', 'asia.png', oOutputParameterHandler)
